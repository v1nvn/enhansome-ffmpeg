...
* [editly](https://github.com/mifi/editly) ⭐ 5,183 | 🐛 77 | 🌐 TypeScript | 📅 2025-05-12 - Declarative video editing tool and library with slick animations and transitions.
...
* [ffmpeg-static](https://github.com/eugeneware/ffmpeg-static) ⭐ 1,265 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-28 - Provides static FFmpeg binaries for macOS, Linux, and Windows. Very useful for CI testing.
* [ffmpeg-concat](https://github.com/transitive-bullshit/ffmpeg-concat) ⭐ 962 | 🐛 51 | 🌐 JavaScript | 📅 2025-09-24 - Concats a list of videos together using FFmpeg with sexy OpenGL transitions.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,034 | 🐛 2,890 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
...
* [Learn FFmpeg libav the Hard Way](https://github.com/leandromoreira/ffmpeg-libav-tutorial) ⭐ 10,639 | 🐛 43 | 🌐 C | 📅 2025-02-01
* [FFmpeg Cheatsheet for Video Automation](https://github.com/rendi-api/ffmpeg-cheatsheet) ⭐ 712 | 🐛 2 | 📅 2025-09-18
