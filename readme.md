...
* [editly](https://github.com/mifi/editly) ⭐ 5,177 | 🐛 77 | 🌐 TypeScript | 📅 2025-05-12 - Declarative video editing tool and library with slick animations and transitions.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,029 | 🐛 2,891 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
...
* [Learn FFmpeg libav the Hard Way](https://github.com/leandromoreira/ffmpeg-libav-tutorial) ⭐ 10,632 | 🐛 43 | 🌐 C | 📅 2025-02-01
* [FFmpeg Cheatsheet for Video Automation](https://github.com/rendi-api/ffmpeg-cheatsheet) ⭐ 554 | 🐛 2 | 📅 2025-09-18
