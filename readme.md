...
* [ffmpeg-concat](https://github.com/transitive-bullshit/ffmpeg-concat) ⭐ 965 | 🐛 51 | 🌐 JavaScript | 📅 2025-09-24 - Concats a list of videos together using FFmpeg with sexy OpenGL transitions.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,038 | 🐛 2,889 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
...
* [FFmpeg Cheatsheet for Video Automation](https://github.com/rendi-api/ffmpeg-cheatsheet) ⭐ 727 | 🐛 2 | 📅 2025-09-18
