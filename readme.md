...
* [ffmpeg-static](https://github.com/eugeneware/ffmpeg-static) ⭐ 1,270 | 🐛 27 | 🌐 JavaScript | 📅 2025-11-14 - Provides static FFmpeg binaries for macOS, Linux, and Windows. Very useful for CI testing.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,041 | 🐛 2,889 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
...
* [Learn FFmpeg libav the Hard Way](https://github.com/leandromoreira/ffmpeg-libav-tutorial) ⭐ 10,656 | 🐛 43 | 🌐 C | 📅 2025-02-01
