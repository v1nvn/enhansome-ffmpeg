...
* [editly](https://github.com/mifi/editly) ⭐ 5,180 | 🐛 77 | 🌐 TypeScript | 📅 2025-05-12 - Declarative video editing tool and library with slick animations and transitions.
...
* [ffmpeg-static](https://github.com/eugeneware/ffmpeg-static) ⭐ 1,264 | 🐛 27 | 🌐 JavaScript | 📅 2023-12-28 - Provides static FFmpeg binaries for macOS, Linux, and Windows. Very useful for CI testing.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,031 | 🐛 2,890 | 🌐 C | 📅 2024-08-13 - Android / iOS video player based on FFmpeg.
...
* [Learn FFmpeg libav the Hard Way](https://github.com/leandromoreira/ffmpeg-libav-tutorial) ⭐ 10,638 | 🐛 43 | 🌐 C | 📅 2025-02-01
* [FFmpeg Cheatsheet for Video Automation](https://github.com/rendi-api/ffmpeg-cheatsheet) ⭐ 691 | 🐛 2 | 📅 2025-09-18
